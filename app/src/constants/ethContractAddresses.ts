...
// Optimism Addresses
export const perpFlashIssuanceContractAddress =
  process.env.REACT_APP_OPTIMISM_PERP_FLASH_ISSUANCE_ADDRESS
export const usdcTokenOptimismAddress =
  process.env.REACT_APP_OPTIMISM_USDC_TOKEN_ADDRESS
export const solunavaxTokenOptimismAddress =
  process.env.REACT_APP_OPTIMISM_SOLUNAVAX_TOKEN_ADDRESS
export const sol1xTokenOptimismAddress =
  process.env.REACT_APP_OPTIMISM_SOL1X_TOKEN_ADDRESS
export const luna1xTokenOptimismAddress =
  process.env.REACT_APP_OPTIMISM_LUNA1X_TOKEN_ADDRESS
export const avax1xTokenOptimismAddress =
  process.env.REACT_APP_OPTIMISM_AVAX1X_TOKEN_ADDRESS
export const tradeModuleOptimismAddress =
  process.env.REACT_APP_OPTIMISM_SETJS_TRADE_MODULE
export const streamingFeeModuleOptimismAddress =
  process.env.REACT_APP_OPTIMISM_SETJS_STREAMING_FEE_MODULE
export const basicIssuanceModuleOptimismAddress =
  process.env.REACT_APP_OPTIMISM_SETJS_BASIC_ISSUANCE_MODULE
export const protocolViewerOptimismAddress =
  process.env.REACT_APP_OPTIMISM_SETJS_PROTOCOL_VIEWER

// Arbitrum Addresses
export const doubloonTokenArbitrumAddress =
  process.env.REACT_APP_ARBITRUM_DBL_TOKEN_ADDRESS
