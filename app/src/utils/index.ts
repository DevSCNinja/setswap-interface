...
import ERC20ABI from 'galleon-sdk/abi/ERC20.json'
import SupplyCapIssuanceABI from 'galleon-sdk/abi/SupplyCapIssuanceHook.json'
...
export const makeEtherscanLink = (
  ...
  if (chainId && chainId === OPTIMISM_CHAIN_DATA.chainId)
    return `https://optimistic.etherscan.io/tx/${transactionHash}`
  if (chainId && chainId === ARBITRUM_CHAIN_DATA.chainId)
